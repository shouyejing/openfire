...
class of_payment_mode(osv.Model):
    ...
    _columns = {
        'type': fields.related('journal', 'type', type='selection', selection=[('sale', 'Sale'),('sale_refund','Sale Refund'), ('purchase', 'Purchase'), ('purchase_refund','Purchase Refund'), ('cash', 'Cash'), ('bank', 'Bank and Checks'), ('general', 'General'), ('situation', 'Opening/Closing Situation')], store=False, string='Type')
    }
...
class account_statement_from_invoice_lines(osv.TransientModel):
...
# Migration : on ajoute le champ company_registry pour les partenaires. Il est définit dans of_sales mais on le rajoute au cas où of_sales ne serait pas installé.
